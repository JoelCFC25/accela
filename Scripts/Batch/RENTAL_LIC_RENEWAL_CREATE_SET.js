/*------------------------------------------------------------------------------------------------------/
| Program: RENTAL_LIC_RENEWAL_CREATE_SET.js  Trigger: Batch
...
if (!configStdChoice.length)
  configStdChoice = "RENTAL_LIC_RENEWAL_CONFIG";
...
var setPrefix = "RENTAL_LIC_RENEWAL";							//   Prefix for set ID
...
if (emailAddress.length)
  aa.sendMail("permits@cityofroseville.com", emailAddress, "", batchJobName + " Results", emailText);
...
function mainProcess()
  ...
  for (thisExp in myExp)  // for each b1expiration (effectively, each license app)
    ...
    if (setPrefix != "" && capCount == 1)
      ...
      var setType = "Rental Licensing Renewal";
